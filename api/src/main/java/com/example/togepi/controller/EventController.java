...
public class EventController {
	...
	public void sendMessageWithKafka(@PathVariable String message) {
		kafkaService.send(kafkaTopic, message);
	}
	
	@PostMapping(value = "/rabbitmq/{message}")
	public void sendMessageWithRabbitMQ(@PathVariable String message) {
		rabbitMQService.send(rabbitMQRoutingKey, message);
	}
}
